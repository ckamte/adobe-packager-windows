...
function showSlides() {
   ...
   for (i = 0; i < slides.length; i++) {
    ...
    setTimeout(showSlides, 20000); // Change image every 20.00 seconds
}
...
function cecDisplayContent(data, locale)
{
	...
	var url = "https://www.adobe.com/"+lcl.toLowerCase()+"/products/photoshop-lightroom-classic.html";
	...
	if(locale == "zh_tw" || locale == "zh_TW") {
		  url = "https://www.adobe.com/tw/products/photoshop-lightroom-classic.html";
	  }
	if(locale == "zh_cn" || locale == "zh_CN") {
		  url = "https://www.adobe.com/cn/products/photoshop-lightroom-classic.html";
	  }
